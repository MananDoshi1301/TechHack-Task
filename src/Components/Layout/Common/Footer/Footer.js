      ...
      >
        <div className='mx-5'>
          <div className='d-flex justify-content-between align-items-center'>
            <div className={`display-2 ${styles.footerHead}`}>
            ...
            <div className='d-flex'>
              {footerList.map((list, key) => {
                return (
                  ...
                  >
                    <div
                      className={`fs-2 fw-bold ${styles.listHead}`}
                      style={{ color: '#2C4E9F' }}
                    >
                      {list.ul[0]}
                    </div>
                    {list.ul[1].map((listItem, key) => {
                      return (
                        <li className={`fs-5 ${styles.listItem}`} key={key}>
                          {listItem.link}
                        </li>
                      );
                    })}
          ...
          <div>
            {/* <div className='container-fluid'>
              <div className='row'>
                <div
                  className={`col-lg-6 col-md-12 col-sm-12 col-12 order-5 order-lg-0 d-flex align-items-center fs-4 ${styles.listHead} fw-bold`}
                  style={{ color: '#2C4E9F' }}
                >
                  &copy; TechHack Technologies 2021 All Rights Reserved.
                </div>
            ...
            <div>
            <div
                  className={`text-center fs-5 mt-1 ${styles.listHead} fw-bold`}
                  style={{ color: '#2C4E9F' }}
                >
                  &copy; TechHack Technologies 2021 All Rights Reserved.
                </div>
